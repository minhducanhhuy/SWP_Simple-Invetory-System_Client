    ...
    <div className="p-6 bg-[#f8fafc] min-h-screen font-sans">
      ...
      <div className="mb-6 flex justify-between items-start">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Quản lý lịch sử thông báo hệ thống và nghiệp vụ
            </p>
          </div>
        </div>
        ...
        <button
          ...
          onClick={() =>
            alert("Tính năng đánh dấu đọc tất cả sẽ cập nhật sau!")
          }
        >
          ...
          <table className="w-full text-left border-collapse">
            ...
            <thead>
              <tr className="border-b border-gray-200 bg-white">
                <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider w-16 text-center">
                  Trạng thái
                </th>
                <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider w-1/4">
                  Tiêu đề
                </th>
                <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider w-32">
                  Phân loại
                </th>
                <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider">
                  Nội dung
                </th>
                <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider w-40">
                  Thời gian
                </th>
                <th className="px-6 py-4 text-[11px] font-semibold text-gray-500 uppercase tracking-wider w-24 text-center">
                  Thao tác
                </th>
              </tr>
            </thead>
                ...
                allNotifications.map((notif) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`text-sm ${notif.isRead ? "text-gray-700 font-medium" : "text-gray-900 font-bold"}`}
                      >
                        {notif.title}
                      </span>
                    </td>
                    ...
                    {/* Phân loại (Badge) */}
                    <td className="px-6 py-4">{renderTypeBadge(notif.type)}</td>
